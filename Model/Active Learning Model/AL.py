...
from returndata import returndataset
...
# get MNIST
trainset_size = 700  # ie., testset_size = 10000
# max_queried = 500
# (X, y) = download()
#choose figure size
(X, y) = returndataset(16)
...
# Ks = [25,10]
# Ks = [10]
#RF16*16 Epoch25 EntropySelection has better result 65.48223350253807
d = {}
stopped_at = -1
